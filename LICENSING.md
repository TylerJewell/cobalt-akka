...
A `LICENSE-cobalt` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [imputnet/cobalt](https://github.com/imputnet/cobalt), Copyright
2024 imput, licensed under AGPL-3.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../cobalt-port/specs/SPEC-001-cobalt.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
